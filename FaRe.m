...
QP::usage =
	"QP[ loopNumber_Integer ]

	QP returns expression of the Schwinger exponent P/Q after the momentum transformations.
...
QP[loops_Integer]:=Block[
	{ac,f,k,K,dd,
	P,Q,Q1,
	Ex1,Ex2,ck2,ck,subk,
	m,n,al,be,pre,clast,si,
	i,j},
	...
	ck2=Coefficient[Ex1,k[[1]]^2];
	ck=Coefficient[Ex1,k[[1]]];
	subk=K[[1]]-ck/(2 ck2);
	Ex2=Ex1/.k[[1]]->subk;
	Ex1=Ex2;
	pre=ck2;
	...
	P=Denominator[Q];
	si=P/clast;
	Q1=si*Q//FullSimplify;
	Return[Q1];
];

QP1[loops_Integer,dd_]:=Block[
	{ac,f,k,K,
	P,Q,Q1,pre,clast,si,
	Ex1,Ex2,ck2,ck,subk,
	m,n,al,be,
...
(*	For[i=1,i<=loops,i++,
	...
	P=Denominator[Q];
	si=P/clast;
	Q1=si*Numerator[Q]//FullSimplify;
	Return[Q1/"P"];
];
...
NumV[Q_,num_,loops_Integer,dd_]:=Block[
	...
	Return[Exp1/Exp[Q]//FullSimplify];
];
...
*)
	...
	For[j=1,j<=loops,j++,
		di[[j]]=Coefficient[Expand[A],letters[[j]]]/2//FullSimplify;
	...
	Q=QP1[loops,diNames]//FullSimplify;
